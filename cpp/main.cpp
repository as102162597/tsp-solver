...
#define USE_NTH_TEST_DATA 1     // choose test data index: 0 ~ 3
...
vector<vector<int>> getTestData(const int idx) {
    ...
    switch (idx) {
        ...
        case 2:
            return vector<vector<int>>(
                {   // cities: 17
                    { nil, 107, 241, 190, 124,  80, 316,  76, 152, 157, 283, 133, 113, 297, 228, 129, 348 },
                    { 107, nil, 148, 137,  88, 127, 336, 183, 134,  95, 254, 180, 101, 234, 175, 176, 265 },
                    { 241, 148, nil, 374, 171, 259, 509, 317, 217, 232, 491, 312, 280, 391, 412, 349, 422 },
                    { 190, 137, 374, nil, 202, 234, 222, 192, 248,  42, 117, 287,  79, 107,  38, 121, 152 },
                    { 124,  88, 171, 202, nil,  61, 392, 202,  46, 160, 319, 112, 163, 322, 240, 232, 314 },
                    {  80, 127, 259, 234,  61, nil, 386, 141,  72, 167, 351,  55, 157, 331, 272, 226, 362 },
                    { 316, 336, 509, 222, 392, 386, nil, 233, 438, 254, 202, 439, 235, 254, 210, 187, 313 },
                    {  76, 183, 317, 192, 202, 141, 233, nil, 213, 188, 272, 193, 131, 302, 233,  98, 344 },
                    { 152, 134, 217, 248,  46,  72, 438, 213, nil, 206, 365,  89, 209, 368, 286, 278, 360 },
                    { 157,  95, 232,  42, 160, 167, 254, 188, 206, nil, 159, 220,  57, 149,  80, 132, 193 },
                    { 283, 254, 491, 117, 319, 351, 202, 272, 365, 159, nil, 404, 176, 106,  79, 161, 165 },
                    { 133, 180, 312, 287, 112,  55, 439, 193,  89, 220, 404, nil, 210, 384, 325, 279, 415 },
                    { 113, 101, 280,  79, 163, 157, 235, 131, 209,  57, 176, 210, nil, 186, 117,  75, 231 },
                    { 297, 234, 391, 107, 322, 331, 254, 302, 368, 149, 106, 384, 186, nil,  69, 191,  59 },
                    { 228, 175, 412,  38, 240, 272, 210, 233, 286,  80,  79, 325, 117,  69, nil, 122, 122 },
                    { 129, 176, 349, 121, 232, 226, 187,  98, 278, 132, 161, 279,  75, 191, 122, nil, 244 },
                    { 348, 265, 422, 152, 314, 362, 313, 344, 360, 193, 165, 415, 231,  59, 122, 244, nil }
                }
            );
